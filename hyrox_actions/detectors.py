"""HYROX action detectors implemented as small state machines."""
...
class ActionStatus:
    """Current state of one action detector."""
...
def build_action_registry(args):
    """Build the HYROX detector registry from CLI arguments."""
    return ActionRegistry(
        [
            SquatCounter(
                ...
                max_angle_gap=args.squat_max_angle_gap,
                max_stance_width=args.squat_max_stance_width,
                max_ankle_y_gap=args.squat_max_ankle_y_gap,
            ...
            LungeCounter(
                stable_frames=args.lunge_stable_frames,
                ...
                min_ankle_y_gap=args.lunge_min_ankle_y_gap,
                cooldown=args.lunge_cooldown,
                down_frames=args.lunge_down_frames,
                up_frames=args.lunge_up_frames,
            ),
            BurpeeCounter(
                stable_frames=args.burpee_stable_frames,
                squat_angle=args.burpee_squat_angle,
                up_angle=args.burpee_up_angle,
                floor_width_ratio=args.burpee_floor_width_ratio,
                floor_height_max=args.burpee_floor_height_max,
                floor_center_y_min=args.burpee_floor_center_y_min,
                flat_floor_width_ratio=args.burpee_flat_floor_width_ratio,
                flat_floor_height_max=args.burpee_flat_floor_height_max,
                flat_floor_center_y_min=args.burpee_flat_floor_center_y_min,
                no_arm_floor_frames=args.burpee_no_arm_floor_frames,
                pushup_down_elbow_angle=args.burpee_pushup_down_elbow_angle,
                pushup_up_elbow_angle=args.burpee_pushup_up_elbow_angle,
                pushup_min_knee_angle=args.burpee_pushup_min_knee_angle,
                broad_jump_min_dx=args.burpee_broad_jump_min_dx,
                stage_timeout=args.burpee_stage_timeout,
                cooldown=args.burpee_cooldown,
                floor_frames=args.burpee_floor_frames,
                up_frames=args.burpee_up_frames,
                landing_frames=args.burpee_landing_frames,
            ),
        ]
    )
